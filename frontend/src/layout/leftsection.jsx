...
const Layout = ({ children }) => {
  return (
    <div
      className="relative flex justify-center items-center h-screen bg-center bg-greeen-600"
      ...
      <div className="pr-30 flex h-screen">
        ...
        <div className="relative pl-10 z-10 w-1/2 flex justify-center items-center">
          {children}
        </div>
      </div>
    </div>
