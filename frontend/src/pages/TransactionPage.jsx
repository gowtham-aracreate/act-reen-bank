...
export const TransactionPage = ({ pageTitle }) => {
  ...
  // Function to add a new transaction (you can call this from a form or modal)
  const addTransaction = (accountType, newTransaction) => {
    setTransactions((prevTransactions) => ({
      ...prevTransactions,
      [accountType]: [...prevTransactions[accountType], newTransaction],
    }));
  };
      ...
      <div className="max-w-6xl">
        <div className="flex mt-17">
          ...
          >
            ...
            <div>
              <button
                onClick={() => setIsSchoolSavingsHidden(!isSchoolSavingsHidden)}
                className="w-10 h-10 mx-6 bg-gray-200 rounded-lg flex items-center justify-center"
              >
                <img
                  className="w-5 h-5 bg-gray-200 rounded-lg cursor-pointer"
                  src={isSchoolSavingsHidden ? EyeClose : EyeOpen}
                  alt="Toggle Balance Icon"
                />
              </button>
            </div>
          ...
          >
            ...
            <div>
              <button
                onClick={() => setIsHolidayPlanHidden(!isHolidayPlanHidden)}
                className="w-10 h-10 mx-6 bg-gray-200 rounded-lg flex items-center justify-center"
              >
                <img
                  className="w-5 h-5 bg-gray-200 rounded-lg cursor-pointer"
